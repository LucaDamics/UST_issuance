...
recon_outlays.csv and cbo_comparison.csv &middot; sources: fiscaldata.treasury.gov (DTS Table II,
MTS Tables 4/5), CBO historical budget data &middot; run 2026-08-05.</footer>
</div>
